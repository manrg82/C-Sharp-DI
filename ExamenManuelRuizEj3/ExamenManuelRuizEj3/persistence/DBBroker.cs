...
namespace ExampleMVCnoDatabase.Persistence
{
    public class DBBroker
    {
        ...
        private const String cadenaConexion = "server=localhost;database=mydb;uid=root;pwd=root";//aqui pongo root en la contraseña porque cuando configuré el mysql puse root en vez de toor
