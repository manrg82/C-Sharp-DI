...
namespace WPF_LoginForm.ViewModel
{
    public class GruposViewModel : INotifyPropertyChanged
    {
        ...
        private void LoadAlumnosDelGrupo(int grupoId)
        {
            try
            {
                var alumnos = _dbBroker.GetAlumnosByGrupo(grupoId);
        ...
        private void Asignar(object? parameter)
        {
            ...
            {
                MessageBox.Show("Debe seleccionar un alumno y un grupo", "Validacion", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                _dbBroker.UpdateAlumno(SelectedAlumnoSinAsignar);
        ...
        private void Desasignar(object? parameter)
        {
            ...
            try
            {
                ...
                _dbBroker.UpdateAlumno(SelectedAlumnoAsignado);
        ...
        private void CrearGrupo(object? parameter)
        {
            ...
            {
                MessageBox.Show("El nombre del grupo es obligatorio", "Validacion", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                int idGrupo = _dbBroker.InsertGrupo(nuevoGrupo);
                ...
                MessageBox.Show("Grupo creado correctamente", "Exito", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private void ModificarGrupo(object? parameter)
        {
            ...
            try
            {
                ...
                _dbBroker.UpdateGrupo(SelectedGrupo);

                LoadData();
                MessageBox.Show("Grupo modificado correctamente", "Exito", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
        ...
        private void EliminarGrupo(object? parameter)
        {
            ...
            var result = MessageBox.Show(
                $"Esta seguro de eliminar el grupo '{SelectedGrupo.Nombre}'?\nLos alumnos seran liberados.",
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    if (_dbBroker.DeleteGrupo(SelectedGrupo.IdGrupo))
                    {
                        ...
                        MessageBox.Show("Grupo eliminado correctamente", "Exito", MessageBoxButton.OK, MessageBoxImage.Information);
                    }
                }
                catch (Exception ex)
                {
